...
void vec4_matrix4_mul(float v[4], float m[4][4], int res[3])
{
    ...
    res[0] = (int)((m[0][0] * v[0] + m[0][1] * v[1] + m[0][2] * v[2] + m[0][3]));
    res[1] = (int)((m[1][0] * v[0] + m[1][1] * v[1] + m[1][2] * v[2] + m[1][3]));
    res[2] = (int)((m[2][0] * v[0] + m[2][1] * v[1] + m[2][2] * v[2] + m[2][3]));

    if (w == 1.0 || w == 0.0) return;
